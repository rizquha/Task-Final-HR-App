...
namespace HR_App.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        string personphone11, string personname21, string personphone21, string personname31, string personphone31,string status1, string username1, string password1)
        {
